...
let { name, myingredients } = chaiRecipe;       //name obj se utkar yaha a gaya --> chaireciepe obj se 
let [firstChai, secondChai] = chaiTypes;      //chaitype array se values aye

console.log(myingredients);     //myingredients is undefined
